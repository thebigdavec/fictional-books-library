	...
	constructor(props) {
		...
		this.state = {
			books: [
				...
				{ title: 'Under The Bleachers', author: 'Seymour Butts', contributor: 'Anonymous'},
				{ title: 'Gone In 60 Seconds', author: 'Carlos', contributor: 'Anonymous'},
				{ title: 'Can You Hear Me?', author: 'Lowden Cleer', contributor: 'Anonymous'},
				{ title: 'Incestuous Relationships', author: 'Mario Cousins', contributor: 'Anonymous'},
				{ title: 'Make Your Garden Grow', author: 'Walter De Plants', contributor: 'Anonymous'},
				{ title: 'Race For The Restroom', author: 'Willy Makeit and Betty Dont', contributor: 'Anonymous'},
				{ title: 'Made It To The Restroom', author: 'Andy Diddenhall and Justin Time', contributor: 'Dave Collison'},
				{ title: 'Magician\'s Secrets', author: 'Howie Duzzit', contributor: 'Dave Collison'},
				{ title: 'Yellow River', author: 'I. P. Freely', contributor: 'Anonymous'},
				{ title: 'Lonely Girl', author: 'Amanda Huggenkiss', contributor: 'Anonymous'},
				{ title: 'Strange But True', author: 'Shirley Knott', contributor: 'Dave Collison'},
				{ title: 'Road Works', author: 'Diggy Knowles', contributor: 'Anonymous'},
				{ title: 'Flat Broke', author: 'Penny Less', contributor: 'Dave Collison'},
				{ title: 'Filthy Rich', author: 'Millie O\'Naire', contributor: 'Dave Collison'},
				{ title: 'Memory Loss', author: 'Sam Nesia', contributor: 'Dave Collison'},
				{ title: 'Who Are You?', author: 'Ann Onnimus', contributor: 'Dave Collison'},
				{ title: 'Not Too Hungry', author: 'Arthur Portion', contributor: 'Dave Collison'}
			],
			index: 0,
			lightmode: false
		};
